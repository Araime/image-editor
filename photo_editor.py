...
class PyPhotoEditor:
    ...
    def draw_menu(self):
        ...
        clipboard_menu.add_command(label="Add image directory to clipboard",
        ...
        edit_menu.add_command(label="Undo", command=lambda: self.move_history_of_current_image("undo"))
        edit_menu.add_command(label="Redo", command=lambda: self.move_history_of_current_image("redo"))
        ...
        crop_menu.add_command(label="Cancel", command=self.cancel_selection_of_current_image)
    ...
    def move_history_of_current_image(self, mode):
        image = self.current_image()
        if not image:
            return
